...
const actions = {
    readCategorias({ commit, state, rootGetters }, instance) {
        return new Promise((resolve, reject) => {
            instance.axios.get(`${instance.apiUrl}/despesas/categoria/read`, {
                params: {
    ...
    createCategoria({ commit, dispatch }, payload) {
        return new Promise((resolve, reject) => {
            ...
            payload.instance.axios.post(`${payload.instance.apiUrl}/despesas/categoria/create`, payload.data).then(
                response => {
    ...
    deleteCategoria({ commit, dispatch }, payload) {
        return new Promise((resolve, reject) => {
            ...
            payload.instance.axios.post(`${payload.instance.apiUrl}/despesas/categoria/delete`, payload.data).then(
                response => {
                    if (response.data == "success") {
                        dispatch("readCategorias", payload.instance);
                        commit("SET_API", "success");
